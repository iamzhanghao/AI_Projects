...
class JHNet(object):
    ...
    def __init__(self, x, skip_layer, is_training, weights_path='DEFAULT'):
        """
        Inputs:
        ...
        if weights_path =='DEFATULT':
            self.WEIGHTS_PATH ="C:\\Users\Hao\Projects\AI_Projects\Brc_Project\weights.npy"
        else:
