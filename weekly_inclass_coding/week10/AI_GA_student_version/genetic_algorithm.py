from week10.AI_GA_student_version.gameplay import *
import week10.AI_GA_student_version.player
import numpy as np
...
class GeneticAlgorithm:
    ...
    def run_genetic_algorithm(self, generations=10):
        ...
        for i in range(0, generations):
            ...
            print("====Generation " + str(i) + " average fitness: " + str(
    ...
    def get_average_survival_time(self, player, days=100, repeat=5):
        ...
        for i in range(0, repeat):
            total_days_survived += self.game.play(player, days, probability_game=self.probability_game,
                                                  use_multinomial=self.use_multinomial, printout=False)
    ...
    def reproduce(self):
        ...
        top_fit_number = int(self.population_size * 0.3)
