...
class somenetclass():
  def __init__(self,dim_in):
    ...
    self.paramsdict['w2']= #shape must be 4d, too. unlike above you do not have 1 channel as input but 20!

    self.paramsdict['w3']= #shape must be 2d bcs it is a fully connected layer

    self.paramsdict['w4']=#shape must be 2d bcs it is a fully connected layer

    self.paramsdict['w5']=#shape must be 2d bcs it is a fully connected layer

    self.paramsdict['b3']=#shape must be 2d with [1, number of output neurons] bcs it is a fully connected layer 
    self.paramsdict['b4']=#shape must be 2d with [1, number of output neurons] bcs it is a fully connected layer 
    self.paramsdict['b5']=#shape must be 2d with [1, number of output neurons] bcs it is a fully connected layer 
  ...
  def predict(self,x,keep_prob):
    ...
    l1=tf.nn.conv2d(xr,filter=20,strides=1,padding="SAME",use_cudnn_on_gpu=True,data_format="NHWC")
    ...
    l3= # fully connected with self.paramsdict['w3'] as weights
    # a relu here 
    l3=tf.nn.relu(l3)
    # a dropout here, uses keep_prob
    l3d= #tf.nn.dropout

    l4=# fully connected with self.paramsdict['w4'] as weights 
    # a relu here 
    l4=tf.nn.relu(l4)
    # a dropout here, uses keep_prob
    l4d= #tf.nn.dropout
