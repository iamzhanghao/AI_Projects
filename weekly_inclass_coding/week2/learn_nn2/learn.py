...
import week2.learn_nn2.modules as modules

importlib.reload(modules)
import week2.learn_nn2.data_io as data_io
...
def testNN2(runs=1, width=3, data="iris.txt",
    ...
    print('Average accuracy', 'rms=False', sum(results[False]) / runs, 'rms=True', sum(results[True]) / runs, end=' ')
