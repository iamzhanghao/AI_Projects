import numpy as np
from week10.AI_GA_student_version.disasters import *
from week10.AI_GA_student_version.player import *
    ...
    def play(self, player, days, probability_game=True, use_multinomial=True, printout=False):
        ...
        if (printout):
            if (died):
                ...
                print(player.id + " survived for : " + str(days_survived) + " days out of " + str(
                    days) + " days, and then killed by a " + final_disaster.id)
