...
class GUI:
 ...
 """
        ...
        self.master.title("Tumor Classifier")
        ...
        self.labelTitle = Label(self.frame, text="Tumor Classifier", font="Verdana 14 bold")
        ...
        self.labelImageResult = Label(self.frame, textvariable=self.singleImageResult, fg="blue", bg="yellow",
        ...
        # self.classifyBtn = Button(self.classifyPanel, text='Run Classification', height=2, width=20,
        #                           command=self.ClassifySingleImage)
        # self.classifyBtn.pack(side=LEFT, padx=5, pady=3)
        self.classifyAllBtn = Button(self.classifyPanel, text='Run Classification', height=2, width=40,
    ...
    def ClassifyAllImages(self):
        ...
        if (self.totalImgNumber == 0):
            ...
            self.resultList = []
            for f in classifyResults:
                if f == 0:
                    self.resultList.append("B")
                elif f == 1:
                    self.resultList.append("M")
                else:
    ...
    def LoadImage(self, name):
        if name != "":
            ...
            if self.resultList[self.curImgNumber] == "":
                ...
                self.singleImageResult.set(value="Size Error")
