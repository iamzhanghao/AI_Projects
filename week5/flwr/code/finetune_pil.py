...
train_file = './flowers_data/trainfile.txt'
val_file = './flowers_data/valtestfile.txt'
replacementpath='./flowers_data/jpg/'
...
# Initialize model
model = AlexNet(x, keep_prob, num_classes, train_layers,is_training)
